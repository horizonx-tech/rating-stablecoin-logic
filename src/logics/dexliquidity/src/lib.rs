...
mod tests {
    ...
    const usdc: [f64; 9] = [ 92852142.73, 96521991.91, 104605045.15, 67397382.39, 72825403.63, 71642046.15, 65437707.89, 64151262.60, 43014497.08];
    const usdt: [f64; 9] = [2466954.95, 20692204.12, 2279293.81, 9899416.37, 1213691.66, 476400.51, 355816.98, 13984077.51, 229678.67];
    const dai: [f64; 9] = [5558588.81, 6043658.45, 5640429.57, 3072559.7, 3295090.65, 1683993.6, 1599624.51, 1644650.53, 7111106.29];
    const fdusd: [f64; 9] = [370916.93, 339327.94, 330683.76, 340056.62, 338320.95, 350043.94, 349716.82, 370261.87, 367124.08];
